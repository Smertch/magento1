...
/**
 * Class RonisBT_StoreLocator_Adminhtml_StoreLocatorController
 *  @category    RonisBT
 * @package     RonisBT_StoreLocator
 */
class RonisBT_StoreLocator_Adminhtml_StoreLocatorController extends Mage_Adminhtml_Controller_Action
{
    /**
     *
     */
